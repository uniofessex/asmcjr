#' @title Bayesian Aldrich-McKelvey Scaling
#' @description  
#' This function performs Bayesian Aldrich-McKelvey (BAM) scaling using JAGS 
#' to estimate ideal points and optionally save intermediate parameters.
#' 
#' @param data A dataset prepared using the \code{\link{bamPrep}} function.
#' @param polarity Integer specifying the column number of the stimulus used to set the polarity.
#' @param zhatSave Logical, whether to save the posterior samples of \code{zhat} (default is TRUE).
#' @param abSave Logical, whether to save the posterior samples of \code{a} and \code{b} parameters (default is FALSE).
